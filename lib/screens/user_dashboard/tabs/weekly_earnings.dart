...
class _WeeklyEarningState extends State<WeeklyEarning> {
  ...
  void firstWeek() async {
    ...
    if (response.statusCode == 200) {
      ...
      print("body is == $body");
      weekOne = body['totalProfit'].toString();
  ...
  void secondWeek() async {
    ...
    if (response.statusCode == 200) {
      ...
      var res = await response.stream.bytesToString();
      var body = jsonDecode(res);
      weekTwo = body['totalProfit'].toString();
  ...
  void thirdWeek() async {
    ...
    if (response.statusCode == 200) {
      ...
      var res = await response.stream.bytesToString();
      var body = jsonDecode(res);
      weekThree = body['totalProfit'].toString();
  ...
  void forthWeek() async {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        weekFour = body['totalProfit'].toString();
      });
    } else {
      print(response.reasonPhrase);
    }
